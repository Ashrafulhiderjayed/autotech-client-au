          ...
          <div id="slide1" className="carousel-item relative w-full">
            ...
            <div className="absolute h-full rounded-xl flex items-center left-0 top-0 bottom-3 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
              <div className='text-white space-y-7 pl-12 w-1/2'>
                ...
                <p>Experiencing issues with your vehicle and seeking professional assistance for car repair? Look no further! Our skilled technicians are dedicated to providing top-notch automotive services.</p>
                <div>
                  <button className="btn text-white bg-mainColor border-none mr-5 hover:bg-black">Discover More</button>
                  <button className="btn btn-outline border-white  text-white">Details</button>
                </div>
              </div>
            </div>
