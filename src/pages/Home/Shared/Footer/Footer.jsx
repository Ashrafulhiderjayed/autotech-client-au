import { FaExclamationCircle, FaExclamationTriangle, FaFacebook, FaGlassMartiniAlt, FaInstagram, FaLaptopMedical, FaLinkedin, FaLocationArrow, FaMailBulk, FaMailchimp, FaNotesMedical, FaPhone, FaSearchLocation, FaTwitter, FaVoicemail, FaYoutube } from 'react-icons/fa';
    ...
    return (
        ...
        <footer className="font-CreteRound footer mt-12 p-10">
          <div>
            ...
            <p className='text-lightWhite mt-8 mb-2'>Discover peace of mind on the road with our expert car repair services. <br /> At AutoTech, our dedicated team of skilled technicians is committed to <br /> delivering reliable and top-notch repairs for your vehicle. </p>
          ...
          <div>
            ...
            <a className="link link-hover">Sydney Harbor Viewpoint</a> 
            ...
            <a className="link link-hover mt-2">Great Barrier Reef Gateway</a>
            ...
            <a className="link link-hover mt-2">Blue Mountains Retreat</a>
